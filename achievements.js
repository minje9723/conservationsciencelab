...
const achievements = [
  ...
  },
  {
    ...
    authors: "Gyu-Ri Choi, Ye-Ni Heo, Sang-Ok Lee",
  ...
  },
  {
    ...
    title_ko: "주조 삼원계(Cu-Sn-Pb) 출토 청동유물의 부식 특성에 따른 부식 유형 연구",
    title_ja: "出土した鋳造型三元系(Cu-Sn-Pb)青銅製品の腐食特性に基づく腐食形態の分類",
    authors: "Go-Woon Bae",
    authors_ko: "배고운",
    authors_ja: "ペ・ゴウン",
    journal: "Korean Journal of Metals and Materials",
    journal_ko: "대한금속재료학회지",
    journal_ja: "韓国金属・材料学会誌",
    ...
    issue: "5",
    pages: "457-468",
    summary_en: "Classification system for corrosion types in Cu-Sn-Pb bronze artifacts based on structural formation of corrosion layers and corrosion product characteristics. Analysis of 5 bronze samples from same archaeological site to identify corrosion layer structures.",
    summary_ko: "주조 삼원계(Cu-Sn-Pb) 청동유물의 부식층 구조 형성 및 부식생성물 특성 기반 부식 유형 분류 시스템 제시. 동일 고고학 유적 출토 청동 시편 5개를 분석하여 부식층 구조 형성을 2가지 주요 유형으로 분류.",
    summary_ja: "Cu-Sn-Pb青銅製品の腐食層構造の形成と腐食生成物の特性に基づく腐食形態分類システムの提示。同一考古学遺跡出土の青銅試料5個を分析し、腐食層の形成を2つの主要タイプに分類。",
    ...
    keywords_ja: ["青銅製品", "腐食特性", "腐食形態", "腐食層", "腐食生成物"]
  },
  {
    id: 45,
    type: "publication",
    ...
    authors: "Hae-Jun Park, So-Yeon Choi, Sin-Gi Kim, Hyeon-Seok Cha, Won-Ju Na, Sang-Ok Lee",
    ...
    issue: "1",
    pages: "98-110",
    summary_en: "Evaluation of surface contaminants on outdoor stone heritage using 3D model and texture color-based quantification techniques. Comparison with conventional 2D methods demonstrates improved spatial precision and visibility.",
    summary_ko: "옥외 석조문화유산 표면오염물 평가를 위해 3D 모델과 텍스처 색상 기반 정량화 기법을 적용. 기존 2D 방법과 비교하여 검출 정밀도 및 가시성 향상을 입증.",
  ...
  },
  {
    ...
    issue: "3",
    pages: "561-570",
    summary_en: "Partial restoration methods for paint damage on outdoor steel sculptures with quantitative stability evaluation. Digital imaging techniques used to assess visual integration and preservation effectiveness.",
    summary_ko: "야외 철제 조각 작품의 페인트 손상 부분복원 방법 제시 및 안정성 정량 평가. 디지털 이미징 기법을 통해 시각적 통합도 및 보존 효과 객관적 평가.",
  ...
  },
  {
    ...
    authors: "Sang-Ok Lee, Min-Je Kim, Sin-Gi Kim",
  ...
  },
  {
    ...
    authors: "Mi-Sol Do, Kwang-Yong Chung",
    authors_ko: "도미솔, 정광용",
    journal: "Journal of Conservation Science",
    journal_ko: "보존과학회지",
    journal_abbr: "J. Conserv. Sci.",
  ...
  },
  {
    ...
    authors: "Min-Soo Park, Kwang-Yong Chung",
    authors_ko: "박민수, 정광용",
    journal: "Journal of Conservation Science",
    journal_ko: "보존과학회지",
    journal_abbr: "J. Conserv. Sci.",
...
const newConferenceAchievements = [
  ...
  },
  {
    ...
    authors: "Hye-Yeni Heo, Gyu-Ri Choi, Sin-Gi Kim, Hyo-Jeong Kim, Sang-Ok Lee",
  ...
  },
  {
    ...
    authors: "Min-Je Kim, Sin-Gi Kim, Chung-Kwang Yong, Sang-Ok Lee",
